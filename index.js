  ...
  var taskGetter = {
    ...
    descriptionMsg: function descriptionMsg(taskName) {
      ...
      if (msg) {
        ...
        console.log(colors.red.bold.underline(task), colors.red.bold("No description given! add description to gulp/taskDescription.json"));
      }
    },
    unDescriptionMsg: function unDescriptionMsg(taskName) {
      ...
      var task = taskGetter.rightPad(taskName, padnum);
      if (!tsk) {
        console.log(colors.red.bold.underline(task), colors.red.bold("No task given! remove description to gulp/taskDescription.json"));
      }
    }
  };
